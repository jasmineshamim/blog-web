...
const CommentSection = () => {
  ...
  const handleFavoriteTopicChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
  ...
  return (
    <div className="comment-section max-w-3xl mx-auto p-4 text-gray-800">
      <h1 className="text-4xl lg:text-5xl font-bold pb-7 text-center text-gray-800">Comment Section</h1>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="mt-4 bg-gradient-to-r from-pink-500 to-blue-500 text-white p-2 rounded font-bold hover:scale-110 ease-in-out duration-100"
        >
          Submit Comment
        </button>
      </form>
